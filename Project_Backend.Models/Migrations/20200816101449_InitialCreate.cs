        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeletedItem = table.Column<string>(maxLength: 450, nullable: false),
                    DateCreated = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApiDeletes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(nullable: false),
                    Error = table.Column<string>(maxLength: 450, nullable: false),
                    DateCreated = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuestionName = table.Column<string>(maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    AnswerId = table.Column<Guid>(nullable: false),
                    AnswerN = table.Column<string>(maxLength: 50, nullable: false),
                    QuestionId = table.Column<Guid>(nullable: false),
